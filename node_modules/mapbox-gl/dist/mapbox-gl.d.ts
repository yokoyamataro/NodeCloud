...
declare class SymbolAppearance {
	...
	getUnevaluatedProperty(name: keyof AppearanceProps): PropertyValue<ResolvedImage, PossiblyEvaluatedPropertyValue<ResolvedImage>> | PropertyValue<number, PossiblyEvaluatedPropertyValue<number>> | PropertyValue<[
		number,
		number
	...
	hasIconProperties(): boolean;
	hasTextProperties(): boolean;
	hasProperty(name: keyof AppearanceProps): boolean;
}
/**
...
declare class SymbolBuffers {
	...
	isEmpty(): boolean;
	getSymbolVertexData(offset: any, numVertices: any): number[];
...
declare class SymbolBucket implements Bucket {
	...
	updateAppearances(canonical?: CanonicalTileID, featureState?: FeatureStates, availableImages?: Array<ImageId>, globalProperties?: GlobalProperties, imageManager?: ImageManager): boolean;
...
type LineDefinesType = "RENDER_LINE_GRADIENT" | "RENDER_LINE_DASH" | "RENDER_LINE_TRIM_OFFSET" | "RENDER_LINE_BORDER" | "LINE_JOIN_NONE" | "ELEVATED" | "VARIABLE_LINE_WIDTH" | "CROSS_SLOPE_VERTICAL" | "CROSS_SLOPE_HORIZONTAL" | "ELEVATION_REFERENCE_SEA" | "LINE_PATTERN_TRANSITION" | "USE_MRT1" | "DUAL_SOURCE_BLENDING";
...
type GlobalDefinesType = "DEBUG_WIREFRAME" | "DEPTH_TEXTURE" | "FOG" | "GLOBE" | "LIGHTING_3D_ALPHA_EMISSIVENESS" | "LIGHTING_3D_MODE" | "NORMAL_OFFSET" | "OVERDRAW_INSPECTOR" | "RENDER_CUTOFF" | "RENDER_SHADOWS" | "RENDER_TO_TEXTURE" | "TERRAIN_DEM_FLOAT_FORMAT" | "TERRAIN";
